...
export async function handler(chatUpdate) {
  ...
  /* Creditos a Otosaka (https://wa.me/5959843037848) */
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;VALU 👑;;;\nFN:VALU 👑\nORG:VALU 👑\nTITLE:\nitem1.TEL;waid=5959843037848:+51 992 621 601\nitem1.X-ABLabel:VALU 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:VALU 👑\nEND:VCARD`;
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Advertencia*', body: 'ALEX', thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/usxr.alxb'}}}}, aa);
